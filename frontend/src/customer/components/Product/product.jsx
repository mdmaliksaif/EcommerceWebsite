        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
             ...
             <div  className='flex justify-between items-center py-10'><h1 className='text-lg opacity-50 font-bold mb-3'>Filters</h1><SortIcon/></div> 
                        ...
                        <Disclosure.Panel className="pt-6">
                          ...
                          <RadioGroup
                            ...
                            {section.options.map((option, optionIdx) => (
                              ...
                              <>
                                 <FormControlLabel onChange={(e)=>handleRadioFilterChanged(e,section.id)} value={option.value} control={<Radio />} label={option.label} />
