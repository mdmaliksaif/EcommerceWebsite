...
<section className='grid grid-cols-1  lg:grid-cols-2 gap-x-8 gap-y-10 px-4 sm:px-6 lg:'> 
 {/* Image gallery */}
 <div className="flex flex-col items-center py-5 ">
          <div className="overflow-hidden rounded-lg max-[35rem] max-h-[30rem]">
            <img
          ...
          <div className="flex flex-wrap spaxce-x-5 justify-center">
         ...
         {/* Product info */}
         <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:px-8
         lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className='text-green-500 font-semibold '>{products.product?.discountPersent
}% off</p>
            </div>
    ...
    <Grid container spacing={7}>
      <Grid item xs={7}> 
        <div className='space-y-5'>
          {[1,1,1,1,1].map((item)=><ProductDetailsReviews />)}
      ...
      <Grid item xs={5}>
        ...
        <div className='flex items-center space-x-3 '>
          <Rating  value={3} precision={.5} readOnly />
        ...
        <Box className="mt-5 space-y-3"> 
         ...
         <LinearProgress sx={{bgcolor:"d0d0d0",borderRadius:4,height:7}} variant='determinate ' value={30} color='success'/>
          ...
          <Grid item xs={7}>
         <LinearProgress sx={{bgcolor:"d0d0d0",borderRadius:4,height:7}} variant='determinate ' value={24} />
          </Grid>         
          </Grid>
          <Grid container  alignItems="center"  gap={2 }>
          <Grid item xs={2}>
          ...
          <Grid item xs={7}>
         <LinearProgress sx={{bgcolor:"d0d0d0",borderRadius:4,height:7}} variant='determinate ' value={18} color='warning'/>
          </Grid>         
          </Grid>
          <Grid container  alignItems="center"  gap={2 }>
          <Grid item xs={2}>
          ...
          <Grid item xs={7}>
         <LinearProgress sx={{bgcolor:"d0d0d0",borderRadius:4,height:7}} variant='determinate ' value={8} color='error'/>
          </Grid>         
          </Grid>
        </Box>
      </Grid>
...
<h1 className='py-5 font-bold'> Similer Products</h1>
